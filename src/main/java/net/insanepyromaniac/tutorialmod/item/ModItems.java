...
public class ModItems {
    ...
    //subroutines to Register Modded Items
    private static Item registerItem(String name, Item item){
        return Registry.register(Registries.ITEM, Identifier.of(TutorialMod.ModID,name),item);
    }

    public static void registerModitems(){
        TutorialMod.LOGGER.info("registering mod items for"+TutorialMod.ModID);
        //adds to the Ingredients Minecraft group
